"""Determine if the app was used at least once per week for 9 consecutive weeks."""
...
app = FastAPI(title="Customer App Retained (Fake Data)")
...
def customer_app_retained() -> bool:
...
__all__ = ["customer_app_retained", "app"]
